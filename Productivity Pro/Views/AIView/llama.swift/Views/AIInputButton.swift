...
struct AIInputButton: View {
    ...
    private func download() {
        guard let extractedInfo = AIInputButton.extractModelInfo(from: inputLink) else {
        ...
        let fileURL = AIInputButton.getFileURL(filename: filename)
        ...
        downloadTask = URLSession.shared.downloadTask(with: url) { temporaryURL, response, error in
            ...
            do {
                if let temporaryURL = temporaryURL {
                    ...
                    let model = AIModel(name: modelName, url: self.inputLink, filename: filename, status: "downloaded")
    ...
    var body: some View {
        VStack {
            ...
            if status == "download" {
                ...
                Button(action: {
                    let fileURL = AIInputButton.getFileURL(filename: self.filename)
