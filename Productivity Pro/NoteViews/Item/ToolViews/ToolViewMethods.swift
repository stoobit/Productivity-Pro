...
extension ToolView {
    ...
    func changeWidth(value: DragGesture.Value) {
        ...
        var newLocation = width ?? size.width
    ...
    func changeHeight(value: DragGesture.Value) {
        ...
        var newLocation = height ?? size.height
    ...
    func changeScale(value: DragGesture.Value) {
        ...
        var newWidth = width ?? size.width
        var newHeight = height ?? size.height
        ...
        size.width *= (newWidth/oldWidth + newHeight/oldHeight)/2
        size.height *= (newWidth/oldWidth + newHeight/oldHeight)/2
